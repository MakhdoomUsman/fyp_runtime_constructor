...
if(isset($_REQUEST['search'])){
    ...
    $select_projects = mysqli_query($con, "select * from projects where title LIKE '%".$term."%' and status=1 order by p_id DESC");
}else{
    $select_projects = mysqli_query($con, "select * from projects where status=1 order by p_id DESC");
}
...
?>
    ...
    <div class="post-bar">
        ...
        <ul class="bk-links">
            ...
            <li><a href="project-view.php?pid=<?php echo $pro_id; ?>" title="" class="bid_now">Bid Now</a></li>
        </ul>
        </div>
        <div class="job_descp">
...
<!-- Post a project - Post a job (Dialog Box) -->
