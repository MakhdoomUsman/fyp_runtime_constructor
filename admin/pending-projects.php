...
<head>
  ...
  <title>All Pending Projects</title>
...
if (isset($_GET['did'])) {
  ...
  $delete_id = $_GET['did'];
  $delete = mysqli_query($con, "delete from projects where p_id='$delete_id'");

  if ($delete) { ?>
    <script>
      location.replace('pending-projects.php');
    </script>
  <?php }
}
...
if (isset($_GET['aid'])) {
  ...
  $approve_id = $_GET['aid'];
  $approve = mysqli_query($con, "update projects set status=1 where p_id='$approve_id'");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-flex align-items-center">
            <h1 class="h2 text-primary">Pending Projects</h1>
          </div>
        	...
        	<div class="table-responsive" style="margin-top: 25px;">
        		<table class="table-hover">
                  ...
                  <th>Delete</th>
        			...
        			$select_inf = mysqli_query($con, "select * from projects where status=0 order by p_id desc");
                ...
                $inf_id = $row['p_id'];
        			?>
        				<tr>
        					...
        					<td><?php echo $row['from_budget']; ?></td>
        					<td><?php echo $row['to_budget']; ?></td>
                  <td>
