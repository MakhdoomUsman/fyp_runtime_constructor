...
<head>
  ...
  <title>Update Skills Options</title>
...
if(isset($_POST['update-skill'])){
  ...
  $update_skill = mysqli_query($con, "update skills set title='$skill_title', min_price='$min_price', max_price='$max_price' where sk_id='$update_id' ");
          ...
          <div class="container col-md-5 row">
            <div class="col-12">
              <?php 
                ...
                $select_skill = mysqli_query($con, "select * from skills where sk_id={$update_id}");
                $skillset = mysqli_fetch_assoc($select_skill);

              ?>
              <h2 class="mt-4">Update Skill</h2>
              <form method="POST" style="padding-bottom: 20px;">
                <div class="row">
                  <div class="col-12" style="margin-bottom: 20px;">
                    <label><h5>Skill Title</h5></label>
                    <input type="text" name="skl-title" value="<?php echo $skillset['title']; ?>" class="form-control">
                  </div>
                  <div class="col-md-6">
                    <label><h5>Minimum Price</h5></label>
                    <input type="number" min="0" value="<?php echo $skillset['min_price']; ?>" name="min-price" class="form-control">
                  </div>
                  <div class="col-md-6">
                    <label><h5>Maximum Price</h5></label>
                    <input type="number" min="0" value="<?php echo $skillset['max_price']; ?>" name="max-price" class="form-control">
                  </div>

                  <div class="col-12" style="margin-top: 15px;">
                    <input type="submit" name="update-skill" value="Update" class="btn btn-warning">
                  </div>
                </div>
              </form>
