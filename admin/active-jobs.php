...
if (isset($_GET['did'])) {
  ...
  if ($delete) { ?>
    <script>
      location.replace('active-jobs.php');
    </script>
  <?php }
}
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-flex align-items-center">
            <h1 class="h2 text-primary">Active Jobs</h1>
          </div>
        	...
        	<div class="table-responsive" style="margin-top: 25px;">
        		<table class="table-hover">
                  ...
                  <th>Delete</th>
        			...
        			$select_inf = mysqli_query($con, "select * from jobs where status=1 order by j_id desc");
